...
class __TwigTemplate_98f81d223c9f43ffcfde5082d4023ff3c1f0bf03e438da6423135362788af4f7 extends Twig_Template
{
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["dateCountPair"]) {
            ...
            if (($this->getAttribute($this->getContext($context, "counts"), "count", array()) == 0)) {
                ...
                echo "\"
              ";
            } elseif (($this->getAttribute($this->getContext($context, "counts"), "count", array()) == 1)) {
                // line 7
                echo "title=\"";
                echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Annotations_AnnotationOnDate", $this->getContext($context, "date"), $this->getAttribute($this->getContext($context, "counts"), "note", array())));
                // line 8
                echo "
";
                // line 9
