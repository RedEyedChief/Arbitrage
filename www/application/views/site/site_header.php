...
<nav id="top-nav" class="navbar navbar-inverse navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="/"> Арбітражні операції</a>

    </div>
    <div class="navbar-collapse collapse">
      <ul class="nav navbar-nav navbar-right">
	<?if(!isset($mail)):?>
        <li><a href="javascript:login.modal.show('signInModal')" role="button">Авторизація</a></li>
	<li><a href="javascript:login.modal.show('signUpModal')" role="button">Реєстрація</a></li>
	<? else: ?>
		        <ul class="nav navbar-nav">
            <li><a href="/orders">Зробити замовлення</a></li>
            <li><a href="/my">Персональна сторінка</a></li>
        </ul>
