...
class Main extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model(array('main_model','user_model',"content_model",'stat_model'));
		$this->load->database();
	...
	//{
	//	$data['news'] = $this->content_model->getNews();
	//	$isLogged = $this->user_model->check_logged();
	//	
	//	if($isLogged)
	//	{
	//		$data['profile'] = $this->session->userdata("profile");
	//		$this->load->view('site/site_header',$data['profile']);
	//		
	...
	//	$this->load->view('site/site_split_left');
	//	$this->load->view('site/site_content',$data);
	//	$this->load->view('site/site_split_content');
	//	if($isLogged)
	//	{
